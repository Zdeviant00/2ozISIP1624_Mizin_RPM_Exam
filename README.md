...
Полная шпаргалка для экзамена по МДК.01.01. Все 37 вопросов с примерами кода, расшифровкой терминов и практическими рекомендациями.

---

<details>
<summary><strong>1. Объясните, чем отличаются простые типы данных от структурированных. Приведите примеры их использования в реальных задачах.</strong></summary>

**Простые (примитивные) типы** — базовые «кирпичики», хранят одно значение, занимают фиксированный объём памяти:
...
**Структурированные типы** — «контейнеры», объединяют несколько значений в одну сущность:
- Массивы (`int[]`) — набор элементов одного типа
...
- Кортежи (`Tuple`) — набор разнотипных значений

### Ключевое отличие — место хранения в памяти
- **Простые типы** (кроме `string`) — **типы-значения** (value types), хранятся в **стеке** (быстрая память)
- **Структурированные типы** (классы, массивы) — **ссылочные типы** (reference types), хранятся в **куче** (heap), на стеке лежит только ссылка (адрес)

### Особый случай — `string`
`string` — **ссылочный тип** (хранится в куче), но ведёт себя как простой:
- **Неизменяемый** (immutable) — любая операция создаёт новый объект
- **Сравнивается по содержимому**, а не по ссылке
...
<details>
<summary><strong>2. Опишите, как выбор типа данных влияет на эффективность программы. Какие ошибки могут возникнуть при неправильном выборе типа данных?</strong></summary>

Выбор типа влияет на **объём памяти**, **скорость вычислений** и **точность результатов**. Неправильный выбор ведёт к переполнению, потере точности или лишнему расходу ресурсов.
...
|--------|-----|
| Деньги | `decimal` |
| Научные расчёты | `double` |
| Графика (точность не критична) | `float` |
| Счётчики, индексы | `int` |
| Очень большие числа | `long` |
...
<details>
<summary><strong>3. Сравните типы данных int, float и double. В каких ситуациях целесообразно использовать каждый из них?</strong></summary>
...
<details>
<summary><strong>4. Какие условные конструкции существуют в C#? Объясните разницу между ними и приведите примеры ситуаций, когда каждая из них наиболее уместна.</strong></summary>
...
<details>
<summary><strong>5. Объясните различия между циклами с постусловием, предусловием и параметром. В каких ситуациях каждый из них наиболее эффективен?</strong></summary>
...
<details>
<summary><strong>6. Сравните процедуры и функции. В каких случаях следует использовать каждый из этих подходов? Приведите примеры.</strong></summary>
...
<details>
<summary><strong>7. Раскройте понятие «область видимости переменной». Как она влияет на работу подпрограмм?</strong></summary>
...
<details>
<summary><strong>8. Объясните, как организовать модульность в программе с использованием подпрограмм. Какие преимущества это даёт?</strong></summary>
...
<details>
<summary><strong>9. Объясните, как подпрограммы помогают избежать дублирования кода. Приведите пример.</strong></summary>
...
<details>
<summary><strong>10. Объясните, что такое массив. В каких задачах использование массивов наиболее эффективно?</strong></summary>
...
<details>
<summary><strong>11. Объясните, как работа со строками отличается от работы с другими типами данных. Приведите примеры операций со строками.</strong></summary>
...
<details>
<summary><strong>12. Опишите, как передача параметров по ссылке отличается от передачи по значению. В каких случаях каждый из способов предпочтителен?</strong></summary>
...
<details>
<summary><strong>13. Какие коллекции существуют в C#? В каких ситуациях каждая из них наиболее эффективна?</strong></summary>
...
<details>
<summary><strong>14. Опишите структуру данных «стек». Какие операции можно выполнять со стеком и в каких задачах он применяется?</strong></summary>
...
<details>
<summary><strong>15. Объясните, как структурированные типы данных помогают организовать сложные данные. Приведите пример.</strong></summary>
...
<details>
<summary><strong>16. Опишите, как классы и объекты используются для моделирования реальных сущностей. Приведите пример класса с его свойствами и методами.</strong></summary>
...
<details>
<summary><strong>17. Сравните поля и свойства в C#. В каких ситуациях что лучше использовать?</strong></summary>
...
<details>
<summary><strong>18. Опишите, как перегрузка методов повышает гибкость программирования. Приведите пример перегруженного метода.</strong></summary>
...
<details>
<summary><strong>19. Объясните, что такое LINQ и какие преимущества он даёт. Приведите примеры использования основных методов.</strong></summary>
...
<details>
<summary><strong>20. Объясните основные принципы ООП: инкапсуляцию, наследование и полиморфизм. Как они способствуют созданию гибких и масштабируемых программ?</strong></summary>
...
<details>
<summary><strong>21. Объясните, как иерархия классов позволяет упростить разработку сложных приложений. Приведите пример наследования классов.</strong></summary>
...
<details>
<summary><strong>22. Перечислите и объясните суть модификаторов доступа в C#. Как они связаны с инкапсуляцией?</strong></summary>
...
<details>
<summary><strong>23. Опишите, как осуществляется подключение и работа с базой данных в C#. Какие основные операции можно выполнять с данными?</strong></summary>
...
**CRUD** — аббревиатура четырёх базовых операций: **Create, Read, Update, Delete**.
...
<details>
<summary><strong>24. Объясните, что такое паттерны проектирования и зачем они нужны. Приведите пример одного паттерна и опишите ситуацию, где он применяется.</strong></summary>
...
<details>
<summary><strong>25. Объясните, как событийно-управляемая модель программирования упрощает создание интерактивных приложений. Какие компоненты чаще всего используются?</strong></summary>
...
<details>
<summary><strong>26. Опишите, как организуется обработка событий в WPF. Приведите пример обработки нажатия кнопки и объясните механизм работы.</strong></summary>
...
<details>
<summary><strong>27. Какие контейнеры компоновки существуют в WPF? Сравните, в каких ситуациях каждый из них лучше всего подходит?</strong></summary>
...
<details>
<summary><strong>28. Опишите основные элементы управления в WPF. В каких ситуациях применяется каждый из них?</strong></summary>
...
<details>
<summary><strong>29. При помощи каких элементов можно организовать навигацию в WPF-приложении? Опишите принцип работы.</strong></summary>
...
<details>
<summary><strong>30. Объясните, что такое Binding в WPF. Как работает Binding и какие режимы Binding существуют?</strong></summary>
...
<details>
<summary><strong>31. Какие элементы используются для отображения списков в WPF? Когда применять каждый из них?</strong></summary>
...
<details>
<summary><strong>32. Опишите способы создания диалоговых и всплывающих окон в WPF. В чём разница между MessageBox и пользовательским окном?</strong></summary>
...
<details>
<summary><strong>33. Опишите основные способы работы с файлами в C#. Какие классы используются для чтения и записи данных?</strong></summary>
...
<details>
<summary><strong>34. Объясните механизм обработки исключительных ситуаций в C#. Как работает конструкция try-catch-finally и когда её следует применять?</strong></summary>
...
<details>
<summary><strong>35. Объясните, как работают операторы is и as для преобразования типов. В чём их отличие от явного приведения типов?</strong></summary>
...
<details>
<summary><strong>36. Какими способами можно конвертировать значения в C#? В чём их отличие?</strong></summary>
...
<details>
<summary><strong>37. Объясните, как выполняются асинхронные операции в C#. Как работают ключевые слова async и await?</strong></summary>
